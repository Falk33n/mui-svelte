...
export { default as ButtonBase } from '$components/ui/button-base/button-base.svelte';
...
type ButtonAttributes = Omit<HTMLButtonAttributes, 'color' | 'aria-busy'>;

type ButtonElementWithoutAnchorAttributes = {
	href?: never;
	hreflang?: never;
	ping?: never;
...
export type ButtonBaseButtonElement = ButtonAttributes &
	ButtonElementWithoutAnchorAttributes;

type AnchorAttributes = Omit<HTMLAnchorAttributes, 'href' | 'color'>;

type AnchorElementWithoutButtonAttributes = {
	href: string;
	type?: never;
	disabled?: never;
	autofocus?: never;
...
export type ButtonBaseAnchorElement = AnchorAttributes &
	AnchorElementWithoutButtonAttributes;
